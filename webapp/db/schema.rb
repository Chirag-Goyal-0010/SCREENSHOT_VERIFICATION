...
ActiveRecord::Schema[8.0].define(version: 2025_09_03_124220) do
  ...
  create_table "phash_results", force: :cascade do |t|
    t.bigint "image_id", null: false
    t.float "similarity"
    t.string "decision"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["image_id"], name: "index_phash_results_on_image_id"
  end
  ...
  add_foreign_key "images", "reference_images"
  add_foreign_key "phash_results", "images"
end
